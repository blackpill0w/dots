;;; electric-ice-light-theme.el --- minimal white theme inspired by editors from 2000s -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup electric-ice-light-theme nil
  "Options for the `electric-ice-light' theme."
  :group 'doom-themes)

(defcustom electric-ice-light-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'electric-ice-light-theme
...
(def-doom-theme electric-ice-light
  ...
  ((bg         '("#fafafa" nil       nil            ))
   ...
   (fg         '("#000000" "#424242" "black"        ))
   (fg-alt     '("#c6c7c7" "#c7c7c7" "brightblack"  ))

   (grey       base5)
   (red        '("#e45649" "#e45649" "red"          ))
   (orange     '("#cc8400" "#dd8844" "brightred"    ))
   (green      '("#55ab2f" "#556b2f" "green"        ))
   ...
   (-modeline-bright t)
   (-modeline-pad
    (when electric-ice-light-padded-modeline
      (if (integerp electric-ice-light-padded-modeline) electric-ice-light-padded-modeline 4)))
...
;;; electric-ice-light-theme.el ends here
