...
(global-set-key (kbd "C-f") 'fzf-find-file)
...
(add-hook 'c++-mode-hook (lambda () (c++-ts-mode)))
(add-hook 'c-mode-hook (lambda () (c-ts-mode)))
(add-hook 'python-mode-hook (lambda () (python-ts-mode)))
(add-hook 'cmake-mode-hook (lambda () (cmake-ts-mode)))
(add-hook 'bash-mode-hook (lambda () (bash-ts-mode)))
...
(use-package lsp-mode
  ...
  (add-hook 'c++-ts-mode-hook (lambda () (setq flycheck-clang-language-standard "c++23")))
  (add-hook 'c++-ts-mode-hook (lambda () (setq flycheck-gcc-language-standard "c++23")))
